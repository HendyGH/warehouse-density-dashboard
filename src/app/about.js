(function (global) {
    ...
    function open() {
        ...
        panel.innerHTML = '<img src="assets/warehouse-icon.png" alt="Warehouse Dashboard icon" width="88" height="88"><h2>Warehouse Dashboard</h2><p data-version>Version 2.1.0</p><p>An offline-capable warehouse dashboard for storage density, inventory visibility, snapshots, and configurable warehouse workflows.</p><p data-profile></p><p data-access></p><p>Your operational data stays in the warehouse folder you choose. Back up that folder regularly.</p><p>Project and documentation: github.com/HendyGH/warehouse-density-dashboard</p><button class="warehouse-primary" data-close>Close</button>';
